...
delay
    B.N L2             // go to compare
L1: SUBS R0, R0, #1    // decrement duration argument
L2: CMP R0, #0         // compare duration argument to zero
    BNE.N L1           // if not equal to 0 go to L1 for decrement
    BX LR              // return
